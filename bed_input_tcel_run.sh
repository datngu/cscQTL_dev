...
nextflow run cscQTL_bed_BOVINCE.nf -resume -w $PWD/bovine_work --outdir "cscQTL_bed_ciri2" --bed_files '/mnt/project/Aqua-Faang/dat/cscqtl/data_revise/ciri2_requant/*.bed' --genotype $genotype --consensus 3 --coloc false -profile cluster  -with-tower -with-report
