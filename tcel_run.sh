...
nextflow run main.nf -resume --outdir "EUR_358_samples" --reads $reads --genotype $genotype --consensus 3 --coloc true --circall true --ciri2 true --circexplorer2 true -profile cluster  -with-tower -with-report
