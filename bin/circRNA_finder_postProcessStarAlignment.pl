#!/usr/bin/env perl
# from https://github.com/orzechoj/circRNA_finder/tree/master
use strict;
use File::Basename;
use Getopt::Long;
use FindBin;
...
my $filterStarProg = $scriptDir."/circRNA_finder_filterCirc.awk";
my $makeBedFileProg = $scriptDir."/circRNA_finder_starCirclesToBed.pl";
my $filterBedFileProg = $scriptDir."/circRNA_finder_filterSpliceSiteCircles.pl";
my $nrFwSplicedReadsProg = $scriptDir."/circRNA_finder_nrForwardSplicedReads.pl";
