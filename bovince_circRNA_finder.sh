...
nextflow run cscQTL_bed_BOVINCE.nf -resume -w $PWD/bovine_work --outdir "cscQTL_bed_circRNA_finder" --bed_files '/mnt/project/Aqua-Faang/dat/cscqtl/data_revise/circRNA_finder_requant/*.bed' --genotype $genotype --coloc false -profile cluster  -with-tower -with-report
