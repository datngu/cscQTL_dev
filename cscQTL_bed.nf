...
workflow {
    ...
    if( params.coloc ){
        ...
        COLOC_BED(params.meta_sumstat, RECOUNT_apply_qvalue.out, RECOUNT_merge_qtl_results_nominal.out, sumstat_ch.collec())
...
process BED_covariate_processing { 
    ...
    publishDir "${params.trace_dir}/cscQTL_bed_qtl_input", mode: 'symlink', overwrite: true
    container 'ndatth/qtl-package:v0.0.0'
    memory '8 GB'
